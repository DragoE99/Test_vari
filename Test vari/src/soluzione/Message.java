...
/**Classe contenente i messaggi per l'utente**/
public class Message {
	
	static String FileEmpty ="File vuoto";
	static String InputError = "Errore di input";
	static String ProgramFail ="Impossibile proseguire con il programma";
